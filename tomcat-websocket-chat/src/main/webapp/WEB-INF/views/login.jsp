			...
			<div class="col-md-4 login-sec">
				...
				<form:form class="login-form" modelAttribute="login"
					...
					<div class="form-group">
						<label for="exampleInputEmail1" class="text-uppercase"><i
							class="fa fa-user" aria-hidden="true"></i> Login</label> <input
							name="username" id="username" class="form-control"
							placeholder="Login" />

					</div>
					<div class="form-group">
						<label for="exampleInputPassword1" class="text-uppercase"><i
							class="fa fa-key" aria-hidden="true"> </i> Mot de passe </label> <input
				...
				<div class="copy-text">
					© 2017, <a href="http://expehris.com"> Expehris</a>
				</div>
