...
<body id='bodybody'>
	...
	<div class="generic-container">
		...
		<div class="panel panel-success">
			...
			<div class="panel-heading ">
				<span class="lead"><b>Charger un nouveau document</b></span>
			</div>
				...
				<form:form method="POST" modelAttribute="fileBucket"
					...
					<div class="row">
						<div class="form-group col-md-8">
							<label class="col-md-3 control-lable" for="file">Charger
								un document</label>
							<div class="col-md-8">
					...
					<div class="row">
						<div class="form-group col-md-8">
							...
							<div class="col-md-7">
								<form:select path="type" onchange="myFunc(value)"
									items="${Types}" />
							</div>
            ...
            "/static/images/up.png"/>" title="Charger un fichier" width="20" height="20"/> </a>--%>
							<a><input type="submit" value="Upload"
								class="btn btn-primary  "></a> <a
								href="<c:url value='/list' />" class="btn  btn-danger ">Retour</a>
	...
	<div class="generic-container">
		<div class="panel panel-primary">
			...
			<div class="panel-heading">
				<span class="lead"><b>Liste des documents chargés</b></span>
			</div>
 ...
 --%>
								...
								<td style="text-align: center"><a
									...
									class="btn btn-xs btn-success "><img
										...
										Télécharger</a> <a
									href="<c:url value='/delete-document-${user.login}-${doc.id}' />"
									class="btn btn-xs btn-danger "><img
										src="<c:url value="/static/images/file.png"/>"
										title="Télécharger le fichier" width="18" height="18" />
										Supprimer</a></td>
							</tr>
						</c:forEach>
