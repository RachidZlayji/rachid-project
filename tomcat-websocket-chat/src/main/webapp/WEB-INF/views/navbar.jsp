		...
		<div class="collapse navbar-collapse" id="f">
			...
			<ul style="float: left" class="nav navbar-nav ">
				...
				<li style="float: left"><a
					href="<c:url value='/list-employeurs' />"><i
						class="fa fa-user " aria-hidden="true"></i> Employeurs </a></li>
				<li style="float: left"><a
					href="<c:url value='/list-comptables' />"><i class="fa fa-user"
						aria-hidden="true"></i> Comptables </a></li>
			...
			<ul style="color: white" class="nav navbar-nav navbar-right">
				<li style="color: red float:right"><img
					src="<c:url value="/static/images/admin-online.png"/>"
					title="Admin" width="50" height="45" />Admin</li>
			</ul>
