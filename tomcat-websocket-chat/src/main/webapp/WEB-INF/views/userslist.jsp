	...
	<div class="generic-container">
		<div class=" panel panel-primary">
			...
			<div class="panel-heading">
				<span class="lead"><b>Liste des salariés </b></span>
			</div>
						...
						<c:forEach items="${users}" var="user">
							<tr>
								...
								<td><a href="<c:url value='/edit-user-${user.login}' />"
									class="btn btn-success custom-width"><img
										src="<c:url value="/static/images/icons8-Edit.png"/>"
										title="Modifier un employé" width="20" height="20" /> Modifier</a></td>
								<td><a href="<c:url value='/delete-user-${user.login}' />"
									class="btn btn-danger custom-width"><img
										src="<c:url value=
            "/static/images/icons8-Trash Can.png"/>"
										title="Supprimer un utilisateur" width="20" height="20" />
										Supprimer</a></td>
								<td><a href="<c:url value='/add-document-${user.login}' />"
									class="btn btn-info custom-width"><img
										src="<c:url value=
            "/static/images/up.png"/>"
										title="Charger un fichier" width="20" height="20" /> Upload</a></td>
								<td><a
									href="<c:url value='/listdocumentbulletinsComptable-${user.login}-2017' />"
									class="btn btn-warning custom-width"><img
										src="<c:url value=
            "/static/images/documents(1).png"/>"
										title="La liste des documents" width="20" height="20" />
										Documents</a></td>
		...
		<div class=" panel panel-heading">
			<a href="<c:url value='/newuser' />"
				class="btn btn-success custom-width"><img
				src="<c:url value="/static/images/user.png"/>"
				title="Ajouter un salarié" width="18" height="18" /> Ajouter</a>
		</div>
