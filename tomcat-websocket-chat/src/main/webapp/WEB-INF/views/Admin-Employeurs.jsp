	...
	<div class="generic-container">
		<div class="panel panel-primary">
			...
			<div class="panel-heading">
				<span class="lead"><b>Liste des employeurs</b> </span>
			</div>
						...
						<c:forEach items="${employeurs}" var="user">
							<tr>
								...
								<td class="text-center"><a
									href="<c:url value='/edit-employeur-${user.login}' />"
									class="btn btn-xs btn-success "><img
										src="<c:url value="/static/images/icons8-Edit.png"/>"
										title="Modifier un employeur" width="20" height="20" />
										Modifier</a> <a
									href="<c:url value='/delete-employeur-${user.login}' />"
									class="btn btn-xs btn-danger "><img
										src="<c:url value=
            "/static/images/icons8-Trash Can.png"/>"
										title="Supprimer un employeur" width="20" height="20" />
										Supprimer</a></td>
							</tr>
						</c:forEach>
					</tbody>
		...
		<div class=" panel panel-heading">
			<a href="<c:url value='/newemployeur' />"
				class="btn btn-success custom-width"><img
				src="<c:url value="/static/images/man(2).png"/>"
				title="Ajouter un employeur" width="20" height="20" /> Ajouter</a>
		</div>
	</div>
