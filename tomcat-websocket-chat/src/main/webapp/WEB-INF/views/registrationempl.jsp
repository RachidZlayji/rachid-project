...
<body id='bodybody'>
	...
	<div class="generic-container">
		<div class="well lead">
			<b>Formulaire d'inscription Employeur</b>
		</div>
		<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				<div style="color: white" class="form-group col-md-6">
					...
					<div class="col-md-7">
						<form:input type="text" path="prenom" id="prenom"
			...
			<div style="color: white" class="row">
				<div class="form-group col-md-6">
					<label class="col-md-3 control-lable" for="nom">Nom <span
						class="red-star"> *</span></label>
					<div class="col-md-7">
						<form:input type="text" path="nom" id="nom"
							class="form-control input-sm" required="true" />
						<div class="has-error">
			...
			<div class="row">
				<div style="color: white" class="form-group col-md-6">
					<label class="col-md-3 control-lable" for="passwd">Password
						<span class="red-star"> *</span>
					</label>
					<div class="col-md-7">
						<form:input type="text" path="passwd" id="passwd"
							class="form-control input-sm" required="true" />
						<div class="has-error">
			...
			<div class="row">
				<div style="color: white" class="form-group col-md-6">
					...
					<div class="col-md-7">
						<form:input type="text" path="entreprise" id="entreprise"
							class="form-control input-sm" required="true" />
						<div class="has-error">
				...
				<div class="form-actions floatRight">
					<c:choose>
						<c:when test="${edit}">
							...
							<a href="<c:url value='/list-employeurs' />"
