...
<body id='bodybody'>
 ...
 <%@include file="/WEB-INF/views/navbar.jsp" %>
	...
	<div class="well lead"><b>Formulaire d'inscription Employeur</b> </div>
 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
		...
		<div class="row">
			<div style="color:white" class="form-group col-md-6">
				...
				<div class="col-md-7">
					<form:input type="text" path="prenom" id="prenom" class="form-control input-sm" required="true"/>
					<div class="has-error">
		...
		<div style="color:white"  class="row">
			<div class="form-group col-md-6">
				...
				<div class="col-md-7">
					<form:input type="text" path="nom" id="nom" class="form-control input-sm" required="true" />
					<div class="has-error">
		...
		<div class="row">
			<div style="color:white"  class="form-group col-md-6">
				...
				<div class="col-md-7">
					<form:input type="text" path="passwd" id="passwd" class="form-control input-sm" required="true"/>
					<div class="has-error">
		...
		<div class="row">
			<div style="color:white"  class="form-group col-md-6">
				...
				<div class="col-md-7">
					<form:input type="text" path="entreprise" id="entreprise" class="form-control input-sm" required="true" />
					<div class="has-error">
		...
		<br>
			<div  class="form-actions floatRight">
				<c:choose>
					<c:when test="${edit}">
						<input type="submit" value="Valider" class="btn btn-success custom-width"/>  <a href="<c:url value='/list-employeurs' />" class="btn btn-danger custom-width">Annuler</a>
					</c:when>
					<c:otherwise>
						<input type="submit" value="Enregistrer" class="btn btn-primary btn-sm custom-width"/>  <a href="<c:url value='/list-employeurs' />" class="btn btn-danger custom-width">Annuler</a>
					</c:otherwise>
				</c:choose>
			</div>
		</div>
