	...
	<div class="generic-container">
		<div class="panel panel-primary">
			...
			<div class="panel-heading">
				<span class="lead"><b>Liste des comptables </b></span>
			</div>
			<div id="collapse1" class="tablecontainer">
				...
				<table id="myTable1" class="table table-hover table-striped">
					<thead>
						<tr style="background-color: rgba(0, 185, 255, 0.3)" class="p3"
							id="myTable tr">
						...
						<c:forEach items="${comptables}" var="user">
							<tr>
								...
								<td class="text-center"><a
									href="<c:url value='/edit-comptable-${user.login}' />"
									class="btn btn-xs btn-success "><img
										src="<c:url value="/static/images/icons8-Edit.png"/>"
										title="Modifier un comptable" width="20" height="20" />
										Modifier</a> <a
									href="<c:url value='/delete-comptable-${user.login}' />"
									class="btn btn-xs btn-danger "><img
										src="<c:url value=
            "/static/images/icons8-Trash Can.png"/>"
										title="Supprimer un comptable" width="20" height="20" />
										Supprimer</a></td>
							</tr>
						</c:forEach>
					</tbody>
		...
		<div class=" panel panel-heading">
			<a href="<c:url value='/newcomptable' />"
				class="btn btn-success custom-width"><img
				src="<c:url value="/static/images/man (5).png"/>"
				title="Ajouter un comptable" width="20" height="20" /> Ajouter</a>
		</div>
	</div>
	<br>
	<br>
