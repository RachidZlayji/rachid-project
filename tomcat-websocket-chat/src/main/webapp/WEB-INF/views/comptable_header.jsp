        ...
        <nav class="navbar navbar-inverse">
           ...
           <div class="container-fluid">
		    ...
		    <ul  class="nav navbar-nav navbar-right">
		    		    <li style=" color:white;float:left" >  <a style="margin:7px ;padding:7px" class="navbar-brand"> <img src="<c:url value="/static/images/comptable_online.png"/>" title="Comptable" width="40" height="20" /></a> </li>
