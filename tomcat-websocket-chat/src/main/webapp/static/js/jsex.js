...
function myFunc($val) {
    if ($val == 'Bulletin de paie') {
        document.getElementById('moisDiv').style.visibility = 'visible';
        document.getElementById('AnneeDiv').style.visibility = 'visible';
    } else {
        document.getElementById('moisDiv').style.visibility = 'hidden';
        document.getElementById('AnneeDiv').style.visibility = 'hidden';
    }
}
function getAnnee($val) {
